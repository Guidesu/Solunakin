      ...
      >
        <Box fontSize="14px">
          ...
          <Button
            ...
            mr="7px"
            width="49%"
<<<<<<< HEAD:tgui/packages/tgui/interfaces/AdminFax.js
            onClick={() => setPaperName('Symphionia Official Report')}>
            Symphionia
=======
            onClick={() => setPaperName('Nanotrasen Official Report')}
          >
            Nanotrasen
>>>>>>> Nova/master:tgui/packages/tgui/interfaces/AdminFax.jsx
          </Button>
          <Button
            icon="s"
            width="49%"
<<<<<<< HEAD:tgui/packages/tgui/interfaces/AdminFax.js
            onClick={() => setPaperName('Symphionia Report')}>
            Symphionia
=======
...
>>>>>>> Nova/master:tgui/packages/tgui/interfaces/AdminFax.jsx
          ...
          <Button icon="s" width="49%" onClick={() => setFromWho('Symphionia')}>
            Symphionia
          </Button>
        </Box>
        <Divider />
