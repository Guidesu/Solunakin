...
<<<<<<< HEAD:modular_skyrat/master_files/code/game/objects/items/RCD.dm
	desc = "A strange, familiar yet distinctly different analogue to the Symphionia standard RCD. Works at range, and can deconstruct reinforced walls. Reload using metal, glass, or plasteel."
...
>>>>>>> Nova/master:modular_nova/master_files/code/game/objects/items/RCD.dm
	icon_state = "rcd"
	worn_icon_state = "RCD"
	ranged = TRUE
	canRturf = TRUE
