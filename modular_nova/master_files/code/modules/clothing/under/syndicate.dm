...
<<<<<<< HEAD:modular_skyrat/master_files/code/modules/clothing/under/syndicate.dm
...
=======
	...
	worn_icon = 'modular_nova/master_files/icons/mob/clothing/under/syndicate.dmi'
>>>>>>> Nova/master:modular_nova/master_files/code/modules/clothing/under/syndicate.dm
