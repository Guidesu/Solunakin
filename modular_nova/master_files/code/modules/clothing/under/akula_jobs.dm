...
/obj/item/clothing/under/akula_wetsuit/job/science
	...
	desc = "The 'Science'-Type Shoredress is yet another model commissioned by Symphionia. This suit has been adapted from 'Ordnance'-Type Shoredresses \
...
/obj/item/clothing/under/akula_wetsuit/job/medical
	...
	desc = "The 'Medical'-Type Shoredress is yet another model commissioned by Symphionia. This suit has been adapted from exploration \
...
/obj/item/clothing/under/akula_wetsuit/job/command
	...
	desc = "The 'Command'-Type Shoredress is yet another model commissioned by Symphionia; but the origins of this wetsuit lie in designs belonging to, \
