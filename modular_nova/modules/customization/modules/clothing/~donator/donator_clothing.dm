...
/obj/item/clothing/mask/animal/wolf/Initialize(mapload)
	. = ..()
<<<<<<< HEAD:modular_skyrat/modules/customization/modules/clothing/~donator/donator_clothing.dm
...
>>>>>>> Nova/master:modular_nova/modules/customization/modules/clothing/~donator/donator_clothing.dm
