...
/obj/item/clothing/shoes/jackboots/black
	name = "dark jackboots"
<<<<<<< HEAD:modular_skyrat/modules/customization/modules/clothing/shoes/shoes.dm
...
=======
	...
	icon = 'modular_nova/master_files/icons/obj/clothing/shoes.dmi'
	worn_icon = 'modular_nova/master_files/icons/mob/clothing/feet.dmi'
>>>>>>> Nova/master:modular_nova/modules/customization/modules/clothing/shoes/shoes.dm
