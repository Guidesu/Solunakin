...
/obj/item/clothing/under/rank/centcom/nova/naval
	name = "ensign uniform"
	desc = "A uniform worn by those with the rank Ensign in the Symphionia Navy."
	icon_state = "naval_ensign"
	can_adjust = TRUE

/obj/item/clothing/under/rank/centcom/nova/naval/commander
	name = "command uniform"
	desc = "A uniform worn by those with a command rank in the Symphionia Navy."
	icon_state = "naval_command"

/obj/item/clothing/under/rank/centcom/nova/naval/admiral
	name = "admiral's uniform"
	desc = "A uniform worn by those with the rank Admiral in the Symphionia Navy."
	icon_state = "naval_admiral"

/obj/item/clothing/under/rank/centcom/nova/naval/fleet_admiral
	name = "fleet admiral's uniform"
	desc = "A uniform worn by those with the rank Fleet Admiral in the Symphionia Navy."
	icon_state = "naval_fleet_admiral"

// GLOVES
/obj/item/clothing/gloves/combat/naval
	name = "nanotrasen naval gloves"
<<<<<<< HEAD:modular_skyrat/modules/nanotrasen_naval_command/code/clothing.dm
	desc = "A high quality pair of thick gloves covered in gold stitching, given to Symphionia's Naval Commanders."
...
>>>>>>> Nova/master:modular_nova/modules/nanotrasen_naval_command/code/clothing.dm
	icon_state = "naval_command"
...
/obj/item/clothing/head/hats/caphat/naval
	name = "naval cap"
	desc = "A cap worn by those in the Symphionia Navy."
	icon_state = "naval_command"
...
/obj/item/clothing/head/hats/caphat/naval/fleet_admiral
	...
	desc = "A cap worn by the Symphionia Fleet Admiral."
	icon_state = "naval_fleet_admiral"
...
<<<<<<< HEAD:modular_skyrat/modules/nanotrasen_naval_command/code/clothing.dm
	desc = "A red padded pauldron signifying the rank of Lieutenant Commander of the Symphionia Navy."
...
/obj/item/clothing/neck/pauldron/commander
	...
	desc = "A red padded pauldron signifying the rank of Commander in the Symphionia Navy."
	icon_state = "pauldron_commander"

/obj/item/clothing/neck/pauldron/captain
	name = "captain's pauldron"
	desc = "A red padded pauldron signifying the rank of Captain in the Symphionia Navy."
	icon_state = "pauldron_captain"

/obj/item/clothing/neck/cloak/admiral
	name = "admiral's cape"
<<<<<<< HEAD:modular_skyrat/modules/nanotrasen_naval_command/code/clothing.dm
	desc = "A vibrant green cape with gold stitching, worn by Symphionia Navy Admirals."
	worn_icon = 'modular_skyrat/master_files/icons/mob/clothing/neck.dmi'
	icon = 'modular_skyrat/master_files/icons/obj/clothing/neck.dmi'
=======
...
<<<<<<< HEAD:modular_skyrat/modules/nanotrasen_naval_command/code/clothing.dm
	desc = "A godly cape worn by the highest ranking person in the Symphionia Navy, the Fleet Admiral."
	worn_icon = 'modular_skyrat/master_files/icons/mob/clothing/neck.dmi'
	icon = 'modular_skyrat/master_files/icons/obj/clothing/neck.dmi'
=======
