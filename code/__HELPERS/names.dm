...
/proc/command_name()
	...
	var/name = "Conglomeration of Colonists"
...
/proc/syndicate_name()
	...
	if (prob(80))
		...
		// Full
		if (prob(60))
			name += pick("Symphionia", "Consortium", "Collective", "Corporation", "Group", "Holdings", "Biotech", "Industries", "Systems", "Products", "Chemicals", "Enterprises", "Family", "Creations", "International", "Intergalactic", "Interplanetary", "Foundation", "Positronics", "Hive")
		// Broken
		else
