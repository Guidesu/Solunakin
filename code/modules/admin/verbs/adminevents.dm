...
/client/proc/admin_headset_message(mob/target in GLOB.mob_list, sender = null)
	...
	to_chat(target, span_hear("You hear something crackle in your [human_recipient ? "ears" : "radio receiver"] for a moment before a voice speaks. \"Please stand by for a message from [sender == "Symphionia" ? "your benefactor" : "Central Command"]. Message as follows[sender == "Symphionia" ? ", agent." : ":"] <b>[input].</b> Message ends.\""), confidential = TRUE)
