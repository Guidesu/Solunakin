...
/datum/techweb_node/tackle_advanced
	...
	description = "Symphionia would like to remind its researching staff that it is never acceptable to \"glomp\" your coworkers, and further \"scientific trials\" on the subject \
