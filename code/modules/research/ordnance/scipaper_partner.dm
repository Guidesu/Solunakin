...
/datum/scientific_partner/defense
	...
	flufftext = "We can work directly for Symphionia's \[REDACTED\] division, potentially providing us access with advanced defensive gadgets."
...
/datum/scientific_partner/medical
	...
	flufftext = "A collegiate of the best medical researchers Symphionia employs. They seem to be interested in the biological effects of some more exotic gases. Especially stimulants and neurosupressants."
	accepted_experiments = list(
...
/datum/scientific_partner/physics
	...
	flufftext = "A prestigious physics journal managed by Symphionia. The main journal for publishing cutting-edge physics research conducted by Symphionia, given that they aren't classified."
	accepted_experiments = list(
