...
/obj/item/gun/energy/pulse/pistol/m1911
	...
	desc = "A compact pulse core in a classic handgun frame for Symphionia officers. It's not the size of the gun, it's the size of the hole it puts through people."
	icon_state = "m1911"
	inhand_icon_state = "gun"
	cell_type = /obj/item/stock_parts/cell/infinite
