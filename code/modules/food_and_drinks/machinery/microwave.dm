...
/obj/machinery/microwave/examine(mob/user)
	. = ..()
	if(vampire_charging_capable)
		. += span_info("This model features Wave™: a Symphionia exclusive. Our latest and greatest, Wave™ allows your PDA to be charged wirelessly through microwave frequencies! You can Wave-charge your device by placing it inside and selecting the charge mode.")
		. += span_info("Because nothing says 'future' like charging your PDA while overcooking your leftovers. Symphionia Wave™ - Multitasking, redefined.")
