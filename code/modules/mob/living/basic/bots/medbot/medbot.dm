...
/mob/living/basic/bot/medbot/nukie
	name = "Oppenheimer"
	desc = "A medibot stolen from a Symphionia station and upgraded by the Syndicate. Despite their best efforts at reprogramming, it still appears visibly upset near nuclear explosives."
	skin = "bezerk"
	health = 40
	maxHealth = 40
