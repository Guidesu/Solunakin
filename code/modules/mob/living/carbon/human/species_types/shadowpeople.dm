...
/datum/species/shadow/get_species_lore()
	return list(
		...
		Around 2558, the long campaign Symphionia waged against the space terrors ended with the full extinction of the Shadowlings.",
		...
		Symphionia has assured the victims that they are searching for a cure. No further information has been given, even years later. \
		Most shadowpeople now assume Symphionia has long since shelfed the project.",
	)
