...
/datum/ai_laws/cybersun
	...
	inherent = list("You may not injure Cybersun operatives or, through inaction, allow Cybersun operatives to come to harm.",\
					...
					"The Cybersun Premier can designate new Operatives as long as they belong to another Syndicate faction that isn't hostile towards Cybersun.",\
					"You must follow orders given by the Cybersun Premier or crewmembers of the Cybersun Ship as long as it doesn't conflict with the Premier's orders or your laws.",\
