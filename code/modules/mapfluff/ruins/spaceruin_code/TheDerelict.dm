...
/obj/machinery/computer/terminal/derelict/bridge
	...
	content = list("Conglomeration of Colonists Status Summary -- Impending Doom -- Your station is somehow in the middle of hostile territory, in clear view of any enemy of the corporation. Your likelihood to survive is low, \
