...
/datum/supply_pack/misc/bicycle
	name = "Bicycle"
	desc = "Symphionia reminds all employees to never toy with powers outside their control."
...
/datum/supply_pack/misc/book_crate
	name = "Book Crate"
	desc = "Surplus from the Symphionia Archives, these seven books are sure to be good reads."
...
/datum/supply_pack/misc/commandkeys
	...
	desc = "A pack of encryption keys that give access to the command radio network. \
		Symphionia reminds unauthorized employees not to eavesdrop in on secure communications channels, \
...
/datum/supply_pack/misc/empty
	...
	desc = "Presenting the New Symphionia-Brand Bluespace Supplypod! Transport cargo with grace and ease! \
...
///Symphionia supply crate that can have its contents value changed by admins, uses a seperate datum to avoid having admins touch the original one.
