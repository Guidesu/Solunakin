/datum/bounty/item/alien_organs
	name = "Alien Organs"
	description = "Symphionia is interested in studying Xenomorph biology. Ship a set of organs to be thoroughly compensated."
...
/datum/bounty/item/adamantine
	name = "Adamantine"
	description = "Symphionia's anomalous materials division is in desparate need of adamantine. Send them a large shipment and we'll make it worth your while."
