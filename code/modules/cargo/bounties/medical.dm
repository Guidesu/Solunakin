...
/datum/bounty/item/medical/lung
	name = "Lungs"
	description = "A recent explosion at Conglomeration of Colonists has left multiple staff with punctured lungs. Ship spare lungs to be rewarded. We'll take cybernetic ones if need be, but only if they're upgraded."
...
/datum/bounty/item/medical/appendix
	name = "Appendix"
	description = "Chef Gibb of Conglomeration of Colonists wants to prepare a meal using a very special delicacy: an appendix. If you ship one, he'll pay."
...
/datum/bounty/item/medical/lizard_tail
	name = "Lizard Tail"
	description = "The Wizard Federation has made off with Symphionia's supply of lizard tails. While CentCom is dealing with the wizards, can the station spare a tail of their own?"
	reward = CARGO_CRATE_VALUE * 6
	wanted_types = list(/obj/item/organ/external/tail/lizard = TRUE)

/datum/bounty/item/medical/cat_tail
	name = "Cat Tail"
	description = "Conglomeration of Colonists has run out of heavy duty pipe cleaners. Can you ship over a cat tail to help us out?"
	reward = CARGO_CRATE_VALUE * 6
