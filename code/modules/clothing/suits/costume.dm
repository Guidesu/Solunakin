...
/obj/item/clothing/suit/syndicatefake
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS|FEET
	desc = "A plastic replica of the Symphionia space suit. You'll look just like a real murderous Symphionia agent in this! This is a toy, it is not made for use in space!"
