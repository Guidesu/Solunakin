...
/obj/item/clothing/accessory/pride
	name = "pride pin"
	desc = "A Symphionia Diversity & Inclusion Center-sponsored holographic pin to show off your pride, reminding the crew of their unwavering commitment to equity, diversity, and inclusion!"
	icon_state = "pride"
