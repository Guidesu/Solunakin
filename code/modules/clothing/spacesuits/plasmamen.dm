...
/obj/item/clothing/head/helmet/space/plasmaman/curator
	...
	desc = "A slight modification on a traditional voidsuit helmet, this helmet was Symphionia's first solution to the *logistical problems* that come with employing plasmamen. Despite their limitations, these helmets still see use by historians and old-school plasmamen alike."
...
/obj/item/clothing/head/helmet/space/plasmaman/captain
	...
	desc = "A special containment helmet designed for the Premier. Embarrassingly enough, it looks way too much like the Head of Personnel's design save for the gold stripes. I mean, come on. Gold stripes can fix anything."
...
/obj/item/clothing/head/helmet/space/plasmaman/centcom_commander
	...
	desc = "A special containment helmet designed for the Higher Conglomeration of Colonists Staff. Not many of these exist, as CentCom does not usually employ plasmamen to higher staff positions due to their complications."
