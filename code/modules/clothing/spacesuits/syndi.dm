...
/obj/item/clothing/head/helmet/space/syndicate/contract
	...
	desc = "A specialised black and gold helmet that's more compact than its standard Symphionia counterpart. Can be ultra-compressed into even the tightest of spaces."
...
/obj/item/clothing/suit/space/syndicate/contract
	...
	desc = "A specialised black and gold space suit that's quicker, and more compact than its standard Symphionia counterpart. Can be ultra-compressed into even the tightest of spaces."
	slowdown = 1
	w_class = WEIGHT_CLASS_SMALL
