...
/datum/antagonist/ert/official/greet()
	. = ..()
	if (ert_team)
		to_chat(owner, "<span class='warningplain'>Conglomeration of Colonists is sending you to [station_name()] with the task: [ert_team.mission.explanation_text]</span>")
	else
		to_chat(owner, "<span class='warningplain'>Conglomeration of Colonists is sending you to [station_name()] with the task: [mission.explanation_text]</span>")
...
/datum/antagonist/ert/official/forge_objectives()
	...
	missionobj.explanation_text = "Conduct a routine performance review of [station_name()] and its Premier."
