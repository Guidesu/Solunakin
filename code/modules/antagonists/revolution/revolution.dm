...
/datum/team/revolution/proc/defeat_effects()
	...
	priority_announce("It appears the mutiny has been quelled. Please return yourself and your incapacitated colleagues to work. \
		We have remotely blacklisted the head revolutionaries in your medical records to prevent accidental revival.", null, null, null, "Conglomeration of Colonists Loyalty Monitoring Division")
