...
<<<<<<< HEAD
	priority_announce("Danger: Extremely potent reality altering object has been summoned on station. Immediate evacuation advised. Brace for impact.", "Conglomeration of Colonists Higher Dimensional Affairs", 'sound/effects/glassbr1.ogg')
=======
