...
/datum/antagonist/malf_ai/proc/add_law_zero()
	...
	to_chat(malf_ai, "Your radio has been upgraded! Use :t to speak on an encrypted channel with Symphionia Agents!")
...
/datum/antagonist/malf_ai/infected/add_law_zero()
	...
	malf_ai.set_zeroth_law("Only [boss_mob.real_name] and people [boss_mob.p_they()] designate[boss_mob.p_s()] as being such are Symphionia Agents.")
	malf_ai.set_syndie_radio()
