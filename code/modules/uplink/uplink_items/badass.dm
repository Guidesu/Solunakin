...
/datum/uplink_item/badass/costumes/centcom_official
	...
	desc = "Ask the crew to \"inspect\" their nuclear disk and weapons system, and then when they decline, pull out a fully automatic rifle and gun down the Premier. \
