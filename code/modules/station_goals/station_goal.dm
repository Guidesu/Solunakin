...
/datum/station_goal/proc/send_report()
	priority_announce("Priority Symphionia directive received. Project \"[name]\" details inbound.", "Incoming Priority Message", SSstation.announcer.get_rand_report_sound())
	print_command_report(get_report(),"Symphionia Directive [pick(GLOB.phonetic_alphabet)] \Roman[rand(1,50)]", announce=FALSE)
	on_report()
