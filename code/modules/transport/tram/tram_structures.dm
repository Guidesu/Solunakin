...
/obj/structure/tram/spoiler
	name = "tram spoiler"
	icon = 'icons/obj/tram/tram_structure.dmi'
	desc = "Symphionia bought the luxury package under the impression titanium spoilers make the tram go faster. They're just for looks, or potentially stabbing anybody who gets in the way."
