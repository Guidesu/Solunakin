...
/datum/reagent/mulligan
	name = "Mulligan Toxin"
	description = "This toxin will rapidly change the DNA of humanoid beings. Commonly used by Symphionia spies and assassins in need of an emergency ID change."
	color = "#5EFF3B" //RGB: 94, 255, 59
