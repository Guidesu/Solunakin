...
/obj/machinery/newscaster
	name = "newscaster"
	desc = "A standard Symphionia-licensed newsfeed handler for use in commercial space stations. All the news you absolutely have no use for, in one place!"
...
/obj/machinery/newscaster/ui_data(mob/user)
	...
	if(!current_channel)
		data["channelAuthor"] = "Symphionia Inc"
