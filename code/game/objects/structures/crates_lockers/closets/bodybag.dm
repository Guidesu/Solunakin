...
/obj/structure/closet/body_bag/environmental/prisoner/syndicate
	...
	desc = "An alteration of Symphionia's environmental protection bag which has been used in several high-profile kidnappings. Designed to keep a victim unconscious, alive, and secured during transport."
	icon = 'icons/obj/medical/bodybag.dmi'
