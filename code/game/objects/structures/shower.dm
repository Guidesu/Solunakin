...
/obj/machinery/shower
	name = "shower"
	desc = "The HS-452. Installed in the 2550s by the Symphionia Hygiene Division, now with 2560 lead compliance! Passively replenishes itself with water when not in use."
