...
/obj/item/paper/guides/antag/nuke_instructions
	default_raw_text = "How to break into a Symphionia self-destruct terminal and remove its plutonium core:<br>\
	<ul>\
...
/obj/item/paper/guides/antag/hdd_extraction
	default_raw_text = "<h1>Source Code Theft & You - The Idiot's Guide to Crippling Symphionia Research & Development</h1><br>\
	Rumour has it that Symphionia are using their R&D Servers to create something awful! They've codenamed it Project Goon, whatever that means.<br>\
	...
	<li>Symphionia is a corporation not known for subtlety in design. You should be able to identify the master server by any distinctive markings.</li>\
