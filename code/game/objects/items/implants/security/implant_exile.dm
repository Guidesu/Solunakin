...
<<<<<<< HEAD:code/game/objects/items/implants/implant_exile.dm
				<b>Name:</b> Symphionia Employee Exile Implant<BR>
...
>>>>>>> Nova/master:code/game/objects/items/implants/security/implant_exile.dm
	return dat
