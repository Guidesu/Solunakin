...
/obj/item/toy/beach_ball/branded
	name = "\improper Symphionia-brand beach ball"
	desc = "The simple beach ball is one of Symphionia's most popular products. 'Why do we make beach balls? Because we can! (TM)' - Symphionia"
