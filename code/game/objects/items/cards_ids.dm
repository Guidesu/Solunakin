...
/obj/item/card/id/examine(mob/user)
	...
	if(HAS_TRAIT(user, TRAIT_ID_APPRAISER))
		. += HAS_TRAIT(src, TRAIT_JOB_FIRST_ID_CARD) ? span_boldnotice("Hmm... yes, this ID was issued from Conglomeration of Colonists!") : span_boldnotice("This ID was created in this sector, not by Conglomeration of Colonists.")
...
/obj/item/card/id/advanced/update_overlays()
	...
	if(registered_name && registered_name != "Premier")
...
/obj/item/card/id/advanced/gold/captains_spare/update_label() //so it doesn't change to Premier's ID card (Premier) on a sneeze
	if(registered_name == "Premier")
		name = "[initial(name)][(!assignment || assignment == "Premier") ? "" : " ([assignment])"]"
...
/obj/item/card/id/advanced/centcom
	...
	desc = "An ID straight from Conglomeration of Colonists."
...
/obj/item/card/id/advanced/black/syndicate_command
	...
	desc = "An ID straight from the Symphionia."
	registered_name = "Symphionia"
	registered_age = null
