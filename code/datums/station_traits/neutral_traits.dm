...
/datum/station_trait/birthday
	...
	weight = 2
	show_in_report = TRUE
	report_message = "We here at Symphionia would all like to wish Employee Name a very happy birthday"
...
/datum/station_trait/birthday/proc/announce_birthday()
	report_message = "We here at Symphionia would all like to wish [birthday_person ? birthday_person_name : "Employee Name"] a very happy birthday"
	priority_announce("Happy birthday to [birthday_person ? birthday_person_name : "Employee Name"]! Symphionia wishes you a very happy [birthday_person ? thtotext(birthday_person.age + 1) : "255th"] birthday.")
	if(birthday_person)
