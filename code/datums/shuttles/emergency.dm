...
/datum/map_template/shuttle/emergency/asteroid
	...
	description = "A respectable mid-sized shuttle that first saw service shuttling Symphionia crew to and from their asteroid belt embedded facilities."
...
/datum/map_template/shuttle/emergency/discoinferno
	suffix = "discoinferno"
	name = "Disco Inferno"
	description = "The glorious results of centuries of plasma research done by Symphionia employees. This is the reason why you are here. Get on and dance like you're on fire, burn baby burn!"
...
/datum/map_template/shuttle/emergency/goon
	suffix = "goon"
	name = "NES Port"
	description = "The Symphionia Emergency Shuttle Port(NES Port for short) is a shuttle used at other less known Symphionia facilities and has a more open inside for larger crowds, but fewer onboard shuttle facilities."
...
/datum/map_template/shuttle/emergency/rollerdome
	...
	description = "Developed by a member of Symphionia's R&D crew that claims to have travelled from the year 2028. \
...
/datum/map_template/shuttle/emergency/lance
	...
	description = "A brand new shuttle by Symphionia's finest in shuttle-engineering, it's designed to tactically slam into a destroyed station, dispatching threats and saving crew at the same time! Be careful to stay out of it's path."
