...
/datum/map_template/shuttle/ruin/caravan_victim
	...
	description = "Small freight vessel, starts near blacked-out with 3 Symphionia Commandos and 1 Symphionia Stormtrooper, alongside a large hull breach."
...
/datum/map_template/shuttle/ruin/syndicate_dropship
	...
	name = "Symphionia Dropship"
	description = "Light Symphionia vessel with laser turrets. Spawns with a Symphionia mob in the bridge."

/datum/map_template/shuttle/ruin/syndicate_fighter_shiv
	suffix = "syndicate_fighter_shiv"
	name = "Symphionia Fighter"
	description = "A small Symphionia vessel with exactly one tile of useful interior space and 4 laser turrets. Starts with a Symphionia mob in the pilot's seat, and extremely cramped."
